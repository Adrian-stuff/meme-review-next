  ...
  return (
    <>
      ...
      <div className="flex-col flex justify-center items-center my-2">
        <div className="flex flex-col justify-center text-center ring-1 dark:ring-gray-600 rounded-lg p-4 my-2 ">
        ...
        <div
          style={{ width: "368px" }}
          className="container w-80 ring-1 dark:ring-gray-600 rounded-lg p-2 my-2"
        >
